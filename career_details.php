...
<head>
    ...
    <title>Career Details | ACEMC - Baypointe</title>
            ...
            <div class="container">
                <div class="col-lg-6">
                    <div class=" display-5 fw-bolder text-center text-xl-start my-5">
                        <h1 class="display-5 fw-bolder text-white mb-lg-2">CAREER</h1>
                        ...
                        <div class="col-lg-5">
                            <div class="info">
                                ...
                                <div class="info-item d-flex">
                                    ...
                                    <div>
                                        <h4>Email:</h4>
                                        <p><?php echo '<a style="color: black;" href="https://mail.google.com/mail/?view=cm&fs=1&to=baypointehospitalmedicalcenter@yahoo.com">' . htmlspecialchars(trim($row['Email'])) . '</a><br>'; ?>
                                        </p>
                                    </div>
                                </div><!-- End Info Item -->
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            ...
                                            foreach ($mobile_num as $mobile) {
                                                echo '<p>' . '<a style="color: black;" href="tel:' . htmlspecialchars(trim($mobile)) . '">' . htmlspecialchars(trim($mobile)) . '</a><br>';
                                                '</p>';
                                            }
                                            ?>
                                        </p>
