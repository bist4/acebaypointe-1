...
<head>
  ...
  <title>Careers | ACEMC - Baypointe</title>
  ...
  <style>
    ...
    .portfolio .portfolio-item .template-card {
      background-color: #f9f9f9;
      padding: 20px;
      border-radius: 8px;
    }

    .portfolio .portfolio-item .details-careers h2 {
      font-size: 24px;
      color: #2b2320;
    }

    .portfolio .portfolio-item .details-careers h3 {
      font-size: 18px;
      color: #2b2320;
    }

    .portfolio .portfolio-item .details-careers p {
      color: #65534c;
      font-size: 16px;
    }

    .portfolio .portfolio-item .details-careers .btn {
...
<body>
  ...
  <main> <!-- Main -->
    <div class="bg-dark py-5 my-5"> <!-- Title -->
      <div class="py-5">
      </div>
      <div class="container">
        <div class="col-lg-6">
    ...
    <section id="portfolio" class="portfolio career">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="col-lg-6 portfolio-item filter-medical">
          ...
          <div class="col-lg-6 portfolio-item filter-corporate">
            <div class="template-card gray-shadow">
              <div class="details-careers">
                <h2 class="color-text">Junior Clinical Pharmacist</h2>
                <h3 class="date-release">Corporate</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                  et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                  aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                  dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
