...
<head>
  ...
  <title>Department and Services | ACEMC - Baypointe</title>
...
<body>
  ...
  <main> <!-- Main -->
      ...
      <div class="container">
        <div class="col-lg-6">
          <div class=" display-5 fw-bolder text-center text-xl-start my-5">
            <h1 class="display-5 fw-bolder text-white mb-lg-2">Department and Services</h1>
    ...
    <!-- Main content of Department and Services -->
    <main id="main" class="main">
        
    </main> <!-- End of the main content of Department and Services -->
  </main> <!-- End Main -->
