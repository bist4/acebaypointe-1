...
<head>
  ...
  <title>Patient Partnership | ACEMC - Baypointe</title>
      ...
      <div class="container">
        <div class="col-lg-6">
          <div class=" display-5 fw-bolder text-center text-xl-start my-5">
            <h1 class="display-5 fw-bolder text-white mb-lg-2">PATIENT PARTNERSHIP</h1>
            <p class="lead text-white-50 mb-0 mb-lg-3">Patient's right & Responsibilities</p>
          </div>
        </div>
      </div>
