...
<body>
                ...
                <div class="row justify-content-center justify-content-md-between mt-4">
                    ...
                    <div class="col-12 col-md-auto d-flex justify-content-center justify-content-md-start">
                        ...
                        <nav class="pagination">
                            ...
                            <span href="#" class="current">3</span> <!-- page where it was chosen -->
                        ...
                        <div class="row gx-5 justify-content-center align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="appointment-item-two-right">
                                    <h2 class="doctor-name display-6 text-center text-md-start">Dr. Juan Dela Cruz</h2>
                                    <div class="appointment-item-content">
                                        <p class="fs-6"><strong>Department:</strong> <span
                                                class="department">Cardiology</span></p>
                                        <p class="fs-6"><strong>Status:</strong> <span class="status">Active</span></p>
                                        ...
                                        <div>
                                            <p><strong>Note: </strong>For <strong>On Call</strong> and <strong>By
                                                    Appointment</strong> Status, <br>
                                                <strong>0939-915-7633 </strong>Local
                                                200 for Smart <br> <strong>0917-545-1566</strong> Local 200 for Globe
                                            </p>
                                        </div>
    ...
    <a href="doctors.html" class="back-to-top d-flex align-items-center justify-content-center"><i
