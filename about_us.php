...
<head>
  ...
  <!-- Google Fonts -->
  <link
    href="assets/fonts/fonts.css" rel="stylesheet">
...
<body>
  ...
  <main> <!-- Main -->
    ...
    <div class="container-fluid px-0" id="mission_vision">
      <section id="services" class="services section-bg mt-5 mb-5 mx-3"> <!-- Container of the mission, vision and core values -->
